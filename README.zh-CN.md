...
- 独立的护盾反馈提供三种包围全身的蓝色半透明动画、五种“先明显增亮再减弱为余辉”的受击效果和三组原创魂心护盾音效。每组音效都会连续混合自制的薄、中、厚三段录音；视觉与声音的大部分变化集中在 0～30 充能，随后平缓过渡至 99。MCM 可在不受伤时分别测试待机、受击及 4/30/99 充能音效。格挡时伯大尼保持动作且不播放受伤语音；关闭反馈时护罩会伴随所选消失声渐隐。
