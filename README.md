...
- Blue Flies and Blue Spiders occupy real slots only up to a soft total of 56.
  Overflow is stored by player and type, then restored up to four per frame as
