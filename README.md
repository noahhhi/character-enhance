...
- Blue Flies and Blue Spiders occupy real slots only up to a soft total of 52.
  Overflow is stored by player and type, then restored up to three per frame as
  slots reopen so sustained attacks resume quickly.
